  ...
  return (
    <main>
      <section className={styles["register"]}>
        <Container>
          <h1 className={styles["register__title"]}>Cadastro</h1>
          <form className={styles["register__form"]} action="">
            ...
            <Separator className={styles["register__separator"]} />
            ...
            <div>
              <h2 className={styles["register__legend"]}>Áreas de Interesse</h2>
              <ul className={styles["register__areas-interest-list"]}>
                <Badge>Turmas</Badge>
            ...
            <p className={styles["register__observation-text"]}>*campos obrigatórios</p>
            <button className={styles["register__submit"]} type="submit">Enviar Cadastro</button>
          </form>
        </Container>
      </section>
    </main>
